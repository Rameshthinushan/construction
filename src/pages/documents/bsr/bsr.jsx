      ...
      <div className="col">
        <div className="row">
          <div className="col">
            ...
            >
              <i className="bi bi-plus-circle-fill me-2"></i>Create New Bsr
            </button>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col">
            <div className="row">
              ...
              <div className="col">
                <input type="text" className="form-control form-control-sm p-3" placeholder="Search Your Bsr"/>
              </div>
            </div>
                ...
                <ul className="list-unstyled small">
                  <li className="site-border-bottom pt-3 pb-3 ps-3 table-header">
                    <div className="row">
                      ...
                      <div className="col-lg-1">Bsr #</div>
                      <div className="col-lg-3">Bsr Name</div>
